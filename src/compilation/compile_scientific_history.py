...
def plot_points_income(data_dir, dir_path, lang) -> str:
    ...
    if lang == 'en':
        file_name = f'The Monthly Income of Scientific Points.png'
        # title = 'The Monthly Income of Research Points'

    else:
        file_name = f'研究点数月收入.png'
...
def compile_scientific_history(doc, data_dir, output_path, lang):
    ...
    dir_path = prepare_compile_section(lang, output_path, "Scientific", "科技")

    pic = plot_points_income(data_dir, dir_path, lang)
